    ...
    <div className="min-h-screen" style={{ background: 'var(--bg-secondary)' }}>
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="space-y-5 text-sm leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
          ...
          <section>
            <h2 className="font-medium text-base mb-2" style={{ color: 'var(--text-primary)' }}>一、信息收集</h2>
          ...
          <section>
            <h2 className="font-medium text-base mb-2" style={{ color: 'var(--text-primary)' }}>二、信息使用</h2>
            <p>我们收集的信息仅用于以下目的：</p>
            <ul className="list-disc pl-5 mt-2 space-y-1">
              <li>优化平台功能和服务体验</li>
          ...
          <section>
            <h2 className="font-medium text-base mb-2" style={{ color: 'var(--text-primary)' }}>三、信息存储与保护</h2>
          ...
          <section>
            <h2 className="font-medium text-base mb-2" style={{ color: 'var(--text-primary)' }}>四、信息共享</h2>
          ...
          <section>
            <h2 className="font-medium text-base mb-2" style={{ color: 'var(--text-primary)' }}>五、用户权利</h2>
          ...
          <section>
            <h2 className="font-medium text-base mb-2" style={{ color: 'var(--text-primary)' }}>六、Cookie 及本地存储</h2>
            <p>本平台使用浏览器本地存储来记录您的登录状态和偏好设置。您可以随时在浏览器设置中清除这些数据。清除后不会影响您正常访问本平台。</p>
          </section>

          <section>
            <h2 className="font-medium text-base mb-2" style={{ color: 'var(--text-primary)' }}>七、未成年人保护</h2>
            <p>本平台不面向未成年人提供服务。若您是未成年人，请在监护人指导下使用本平台。</p>
          </section>

          <section>
            <h2 className="font-medium text-base mb-2" style={{ color: 'var(--text-primary)' }}>八、政策更新</h2>
            <p>我们可能会不时更新本隐私政策。重大变更时，我们将在平台上发布通知。继续使用本平台即表示您同意更新后的隐私政策。</p>
          </section>

          <section>
            <h2 className="font-medium text-base mb-2" style={{ color: 'var(--text-primary)' }}>九、联系方式</h2>
