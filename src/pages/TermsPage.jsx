    ...
    <div className="min-h-screen" style={{ background: 'var(--bg-secondary)' }}>
      <div className="max-w-3xl mx-auto px-4 sm:px-6 py-12">
        ...
        <div className="space-y-5 text-sm leading-relaxed" style={{ color: 'var(--text-secondary)' }}>
          ...
          <section>
            <h2 className="font-medium text-base mb-2" style={{ color: 'var(--text-primary)' }}>一、协议说明</h2>
            <p>欢迎使用逻辑透镜（以下简称"本平台"）。本平台由 廖莽（个人运营）提供，是个人数据研究与学习交流项目。使用本平台服务前，请仔细阅读本协议。访问或使用本平台即视为您已阅读、理解并同意受本协议约束。</p>
          </section>

          <section>
            <h2 className="font-medium text-base mb-2" style={{ color: 'var(--text-primary)' }}>二、服务内容</h2>
            <p>本平台是个人兴趣驱动的数据研究项目，通过对公开赛事历史数据进行统计分析与机器学习建模，展示数据训练与分析结果。平台所呈现的所有内容均为个人学习与研究目的，仅供数据爱好者交流参考。</p>
          </section>

          <section>
            <h2 className="font-medium text-base mb-2" style={{ color: 'var(--text-primary)' }}>三、免责声明</h2>
          ...
          <section>
            <h2 className="font-medium text-base mb-2" style={{ color: 'var(--text-primary)' }}>四、用户行为规范</h2>
          ...
          <section>
            <h2 className="font-medium text-base mb-2" style={{ color: 'var(--text-primary)' }}>五、知识产权</h2>
            <p>本平台的所有内容，包括但不限于文字、数据、图表、模型、界面设计等，均归运营者所有，受著作权法等相关法律保护。未经书面许可，不得复制、转载、修改或用于商业用途。</p>
          </section>

          <section>
            <h2 className="font-medium text-base mb-2" style={{ color: 'var(--text-primary)' }}>六、协议修改</h2>
            <p>本平台保留随时修改本协议的权利。修改后的协议将在本页面公布，继续使用本平台即视为接受修改后的协议。建议您定期查阅本协议。</p>
          </section>

          <section>
            <h2 className="font-medium text-base mb-2" style={{ color: 'var(--text-primary)' }}>七、联系方式</h2>
